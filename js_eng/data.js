...
const GOOGLE_DRIVE_LINKLERI = {
    buyukada: {
        isim: "Buyukada Tour",
        aciklama: "How about a pleasant tour between the historical pavilions and pine forests in Buyukada, the largest of the islands? We sweat a little while climbing Aya Yorgi, but the landscape is definitely worth it! Who doesn't want to ride a bike in this breathtaking place with its great nature and exquisite landscapes! 🚲🌲 ", 
        resimler: [
    ...
    heybeliada: {
        isim: "Heybeliada Tour",
        aciklama: "Are you ready to pedal in the unique view of Heybeliada, on the routes where nature and history meet? He visits the Seminary School while moving on the pine -scented roads, We enjoy the exquisite landscapes of Heybeliada. ⛰️🌅 ",
        resimler: [
    ...
    bostanci: {
        isim: "Bostanci-Maltepe Coastline Tour",
        aciklama: "Who doesn't want a spacious driving experience by the sea? Bostanci is pedaling with seagulls on the coastline extending from Bostanci to Maltepe, We take pleasant breaks between each other and breathe with great sea air. 🌊☕ ",
        resimler: [
    ...
    anadolukavagi: {
        isim: "Anadolu Kavagi Tour",
        aciklama: "How about a pleasant journey to the north of the Bosphorus? Along the beach, we pedal in the famous sea mood and discover the throat with our bikes. On this beautiful route, we accumulate memories that we will not forget. 🚴‍♂️ ",
        resimler: [
    ...
    beykoz: {
        isim: "Beykoz Forest Trail Tour",
        aciklama: "How would you like to move away from the noise of the city and travel to the heart of nature? In the lush forests of Beykoz, we are pedaling with bird sounds. Even though we have a little difficulty in the trails, we chat at breaks and collect our energy. A nice adventure with nature! 🌳💚 ",
        resimler: [
    ...
    rumelikavagi: {
        isim: "Rumeli Kavagi Tour",
        aciklama: "An unforgettable tour with the unique view of the Bosphorus! While we are pedaling with historical mansions, bridges and sea views, we take breaks at the most beautiful photo points. We discover the European side of the Bosphorus together and collect plenty of moments. 🌅🌉 ",
        resimler: [
    ...
    canakkale: {
        isim: "Canakkale Tour",
        aciklama: "In this tour, which is both emotional and fun, we visit the martyrs and turn our pedals in the exquisite atmosphere of Canakkale. We take lots of photos and accumulate unforgettable memories together. 🇹🇷✨ ",
        resimler: [
    ...
    bursa: {
        isim: "Bursa Tour",
        aciklama: "A journey to the rich culture of Bursa!In this tour, we both visit the cultural fields and pamper ourselves with the exquisite tastes of Bursa.Of course we don't forget to pedal while doing these! 🚴‍♂️💚 ",
        resimler: [
    ...
    konya: {
        isim: "Konya Tour",
        aciklama: "A little culture, a little history, and plenty of pleasure! In this tour, we will visit Konya and its rich culture and turn our pedals in the great nature of Konya. No memorable memories do not return without saving! 🚐🌟 ",
        resimler: [
